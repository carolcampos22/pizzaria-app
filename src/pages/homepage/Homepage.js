...
export const Homepage = () => {
    ...
    return (
        <div className="flex flex-col min-h-[75vh] bg-black p-24">
            <div>
                <h3 className="mr-5 text-5xl text-orange-500">
                    <span className="text-blue-700 cursor-pointer" onClick={() => goToSignUpPage(navigate)}>Cadastre-se</span> ou <span className="text-green-700 cursor-pointer" onClick={() => goToLoginPage(navigate)}>faça login</span> e conheça nosso cardápio!
                </h3>
