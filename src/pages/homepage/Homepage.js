export const Homepage = () => {
    return (
        <div className="bg-black p-2">
            <h3 className="mr-5 text-5xl text-orange-500">Pizzas</h3>
            <div className="flex items-center m-5   ">
                
                <div className="flex">
                    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRQRzHq1cwWSplqrvMQlfhtSuxDSjbUyNZvJA&usqp=CAU" className="w-1/4 mr-4"/>
                    <img src="https://www.receitasnestle.com.br/sites/default/files/srh_recipes/d036cd01122da62bf581784f52d99b3a.jpg" className="w-1/4 mr-4"/>
                    <img src="https://www.paollarestaurante.com.br/uploads/images/2019/08/pizza-strogonoff-de-carne-1565146013.jpg" className="w-1/4 mr-4" />
                    <img src="https://www.ogastronomo.com.br/upload/389528334-curiosidades-sobre-a-pizza-portuguesa.jpg" className="w-1/4 mr-4"/>
                </div>
